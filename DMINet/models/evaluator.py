...
class CDEvaluator():
    ...
    def __init__(self, args, dataloader):
        ...
        #logger_path = args.checkpoint_dir + 'log_test.txt'
    ...
    def _load_checkpoint(self, checkpoint_name='best_ckpt.pt'):
        ...
        if os.path.exists(os.path.join(self.checkpoint_dir, checkpoint_name)):
        #if os.path.exists(self.checkpoint_dir + checkpoint_name):
            ...
            #new_state_dict = {}
            #for key, value in checkpoint['model_G_state_dict'].items():
            #  new_key = key.replace("conv1", "module.resnet.conv1")
            #  new_key = new_key.replace("bn1", "module.resnet.bn1")
              # add more replacements for other layers as needed
    ...
    def _collect_running_batch_states(self):
        ...
        if np.mod(self.batch_id, 1) == 0:
            ...
            #file_name = self.vis_dir + 'eval_' + str(self.batch_id)+'.jpg'
